(() => {
    ...
    function initSliders() {
        if (document.querySelector(".testimonials__slider")) new core(".slider-items__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".btn-slider__btn.swiper-button-prev",
                nextEl: ".btn-slider__btn.swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".testimonials__slider")) new core(".testimonials__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".testimonials__prev.swiper-button-prev",
                nextEl: ".testimonials__next.swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".block-sliders__image")) {
            let thumbsSwiper = new core(".small-slider__slider", {
...
***************************************************************************** */
    ...
    da.init();
    var buttons = document.querySelectorAll(".items-monthly-deals-btn__like");
    function toggleClassOnClick() {
        this.classList.toggle("orange-btn");
    }
    for (var i = 0; i < buttons.length; i++) buttons[i].addEventListener("click", toggleClassOnClick);
    window["FLS"] = true;
    isWebp();
    addTouchClass();
    menuInit();
