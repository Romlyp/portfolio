(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-quickit")) new swiper_core_Swiper(".slider-quickit", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            pagination: {
                el: ".swiper-pagination--access",
                clickable: true
            },
            on: {}
        });
        if (document.querySelector(".slider-statistics")) new swiper_core_Swiper(".slider-statistics", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            pagination: {
                el: ".swiper-pagination--statistics",
                clickable: true
            },
            on: {}
        });
    ...
    da.init();
    let user_icon = document.querySelector(".items-menu__block-lang");
    user_icon.addEventListener("click", (function(e) {
        let user_menu = document.querySelector(".items-menu__languages");
        user_menu.classList.toggle("_active");
    }));
    document.documentElement.addEventListener("click", (function(e) {
        if (!e.target.closest(".items-menu__block-lang")) {
            let user_menu = document.querySelector(".items-menu__languages");
